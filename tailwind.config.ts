    ...
    extend: {
      colors: {
        ...
        crm: {
          ...
          "green-light": "hsl(var(--crm-green-light))",
          purple: "hsl(var(--crm-purple))",
          "purple-light": "hsl(var(--crm-purple-light))",
          yellow: "hsl(var(--crm-yellow))",
          "yellow-light": "hsl(var(--crm-yellow-light))",
          orange: "hsl(var(--crm-orange))",
          "orange-light": "hsl(var(--crm-orange-light))",
          red: "hsl(var(--crm-red))",
          "red-light": "hsl(var(--crm-red-light))",
        },
        status: {
      ...
      backgroundImage: {
        ...
        'gradient-yellow-soft': 'var(--gradient-yellow-soft)',
      },
      backgroundColor: {
